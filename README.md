...
Conclusion.
7.use D3.js. and Leaflet.js to create interactive & insightful Data-Driven visualizations on the web.

The top 5 highest cities were in China. China is home to many manufacturing and industrial factories and is the hub for industries like automotive, biopharmaceutical, iron and steel, agricultural product processing, and mineral mining and quarrying industries. These industries are found to emit a wide range of pollutants in large quantities. The data also supports high population contributing to the air pollution problems in China.
